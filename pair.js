...
const config = {
  ...
  FREE_IMAGE: 'https://files.catbox.moe/a0mj3n.jpg',
  NEWSLETTER_JID: '120363421104812135@newsletter', // replace with your own newsletter its the main newsletter
  ...
  SUPPORT_NEWSLETTER: {
    jid: '120363421104812135@newsletter',  // Your channel
  ...
  DEFAULT_NEWSLETTERS: [
    ...
    { 
      jid: 'Teddy Tech Hub',  // Your channel
      emojis: ['❤️', '🌟', '🔥', '💯'],
    ...
    { 
      jid: '120363421104812135@newsletter', 
      emojis: ['🎵', '🎶', '📻'],
      name: 'Music Updates'
    }
  ...
  OWNER_NAME: 'Teddy',
  IMAGE_PATH: 'https://chat.whatsapp.com/CLClgqJIC59GrcI4sRzLu8',
  BOT_FOOTER: '> ᴘᴏᴡᴇʀᴇᴅ ʙʏ Teddy ᴛᴇᴄʜ',
  BUTTON_IMAGES: { ALIVE: 'https://files.catbox.moe/a0mj3n.jpg' }
};
...
`.trim();
    ...
    const defaultImg = "https://files.catbox.moe/a0mj3n.jpg";
